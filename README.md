# Neural Network Implementation For Simple Logic Gates
  ...
  The predictions of the network converge to the correct target for each output after a sufficent number of epochs. Here is what the output of the 2-hidden neuron NN with training data for an XOR looks like after 100,000 epochs of learning, where each epoch consists of a prediction for each of the 4 possible inputs: 
